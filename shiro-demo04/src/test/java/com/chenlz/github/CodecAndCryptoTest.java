...
/**
 * 加密，解密算法
 * @Title: CodecAndCryptoTest.java
 * @Package com.chenlz.github
 * @author chenlz
 * @date 2017-6-11 下午04:11:43
 * @version V1.0
 */
public class CodecAndCryptoTest {
	...
	public void testHashService() {
		...
		HashRequest request = new HashRequest.Builder().setAlgorithmName("MD5").setSource(ByteSource.Util.bytes("hello")).setSalt(
				ByteSource.Util.bytes("123")).setIterations(2).build();
