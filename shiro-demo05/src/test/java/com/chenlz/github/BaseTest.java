...
import com.chenlz.github.service.impl.PermissionServiceImpl;
import com.chenlz.github.service.impl.RoleServiceImpl;
import com.chenlz.github.service.impl.UserServiceImpl;
...
public class BaseTest {
	...
	@Before
	public void setUp() {
		JdbcTemplateUtils.getInstance().update("delete from t_sys_users");
		JdbcTemplateUtils.getInstance().update("delete from t_sys_roles");
		JdbcTemplateUtils.getInstance().update("delete from t_sys_permissions");
		JdbcTemplateUtils.getInstance().update("delete from t_sys_users_roles");
		JdbcTemplateUtils.getInstance().update("delete from t_sys_roles_permissions");
		...
		// 4、新增用户
		u1 = new User("chenlz", password);
		u2 = new User("mayue", password);
